    ...
    <>
          ...
          <div className="box-itens">
            ...
            <div className="item">
              ...
              >
                ...
                <p>
                  Aumenta a procura por tratamentos para sequelas deixadas pela
                  Covid-19
                </p>
              </a>
            </div>
      ...
      <Sobre id="sobre">
        <div className="container">
          <h2>Sobre nós</h2>
          <p>
            Cristiane Cruz é fisioterapeuta intensivista formada há 5 anos pelo
            Unianchieta, Pós-Graduada em Terapia Intensiva e Mestre em Ciências
            da saúde.
          </p>
          <p>
        ...
        <div className="container">
          ...
          <div className="box-itens">
            <div className="item">
              ...
              <a
                href="https://goo.gl/maps/uZY198WGZrz24NDP8"
                target="_blank"
                rel="noreferrer"
              >
                R. Barão de Teffé, 1000 - Aglomeração Urbana de Jundiaí, Jundiaí
                - SP, 13208-761
              </a>
            </div>
            <div className="item">
              ...
              <h4>Local de atendimento</h4>
              <a
                href="https://goo.gl/maps/bdCRzGemdiYKDXU47"
                target="_blank"
                rel="noreferrer"
              >
